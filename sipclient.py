...
#            mc.ec_tail_len = 800 
    ...
    def call(self):
        ...
        self._call = self.acc.make_call("sip:"+CALLINGID+"@"+SIP_SERVER, DBCallCallback())
    ...
    def run(self):
        try:
            ...
            while True:
                ...
                if(key ==  1):
                    try:
                        log("calling extension "+CALLINGID)
                        self.station.call()
                    except pj.Error, ee:
                        print ee
                    time.sleep(2)
